...
static const struct TrainerMonCustomized sParty_Jerry1[] = {
    {
    .iv = 10,
    .lvl = 9,
    .species = SPECIES_RALTS,
...
static const struct TrainerMonCustomized sParty_Calvin1[] = {
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 1,
        .moves = {MOVE_ENDEAVOR, MOVE_QUICK_ATTACK},
...
static const struct TrainerMonCustomized sParty_Allen[] = {
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 15,
        .moves = {MOVE_MEGA_DRAIN, MOVE_VENOSHOCK},
    ...
    },
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 15,
        .moves = {MOVE_ROLLOUT, MOVE_ICY_WIND, MOVE_BRINE},
        .nature = TRAINER_PARTY_NATURE(NATURE_SERIOUS),
    },
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 15,
        .moves = {MOVE_FLAME_CHARGE, MOVE_BUG_BITE},
        .nature = TRAINER_PARTY_NATURE(NATURE_SERIOUS),
    },
};
...
static const struct TrainerMonCustomized sParty_Ivan[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_MAGIKARP,
...
static const struct TrainerMonCustomized sParty_GinaAndMia1[] = {
    {
    .iv = 0,
    .lvl = 6,
    .species = SPECIES_SEEDOT,
...
static const struct TrainerMonCustomized sParty_Haley1[] = {
    {
    .iv = 0,
    .lvl = 6,
    .species = SPECIES_LOTAD,
...
static const struct TrainerMonCustomized sParty_Rick[] = {
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 14,
        .moves = {MOVE_BUG_BITE, MOVE_POISON_STING},
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    },
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 14,
        .moves = {MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_REST},
        .nature = TRAINER_PARTY_NATURE(NATURE_BOLD),
    },
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 14,
        .moves = {MOVE_STRUGGLE_BUG, MOVE_SLEEP_POWDER},
        .nature = TRAINER_PARTY_NATURE(NATURE_BOLD),
    },
};
...
static const struct TrainerMonCustomized sParty_Dawson[] = {
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 18,
        .moves = {MOVE_HYPER_FANG, MOVE_QUICK_ATTACK},
        .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY),
    },
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 18,
        .moves = {MOVE_FLAIL, MOVE_HEADBUTT, MOVE_CRUNCH},
        .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY),
    },
    {
    ...
    },
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 17,
        .moves = {MOVE_CRUNCH, MOVE_BELCH, MOVE_HEADBUTT, MOVE_QUICK_ATTACK},
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    },
};
...
static const struct TrainerMonCustomized sParty_Sarah[] = {
    {
        ...
        .iv = TRAINER_PARTY_IVS(31,31,31,31,31,31),
        .lvl = 16,
        .moves = {MOVE_BELLY_DRUM, MOVE_PLAY_ROUGH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH},
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    },
};
